                    ...
                    <div className="detail__info">
                        ...
                        <div className="detail__cast">
                            ...
                            <div className="detail__cast__members">
                                {castArray?.map(cast => <div className="cast__member"> {cast?.profile_path && <img className="cast__image" src={`${image_url}${cast?.profile_path}`}></img>} <p className="cast__name">{cast?.name}</p> </div>)}
                            </div>
                        </div>
                    </div>
