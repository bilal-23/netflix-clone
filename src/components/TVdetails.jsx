...
const MovieDetails = () => {
  ...
  const detailMovieUrl = `tv/${movie_id}?api_key=${API_KEY}`;
  const castAndCrewUrl = `tv/${movie_id}/credits?api_key=${API_KEY}&language=en-US`;
  const externalIdUrl = `tv/${movie_id}/external_ids?api_key=${API_KEY}&language=en-US`;
  const similarUrl = `tv/${movie_id}/similar?api_key=${API_KEY}&language=en-US`;
          ...
          <div className="detail__info">
            ...
            <div className="detail__externalLinks">
              {externalLinks?.instagram_id && (
                ...
                >
                  <img
                    className="detail__externalLink__icon"
                    src={instagram}
                    alt="Instagram icon"
                  />
                </a>
