  ...
  return (
    <>
      <div className="movie__card__wrapper">
        {!imageIsLoaded && (
          <div className="image__placeholder">{<ImageLoader />}</div>
        )}
        ...
        <div
          ...
          style={{
            ...
            transform: imageIsLoaded && "scale(1)",
          }}
        >
          ...
          <div className="movie__card__info">
            <h3 className="movie__card__name">
              {movie?.name || movie?.title || movie?.original_title}
            </h3>
            <div className="movie__card__additionalInfo">
              <span className="movie__card__rating">
                {(movie?.vote_average * 10).toFixed(2)}% Match
              </span>{" "}
              <span className="movie__card__year">
